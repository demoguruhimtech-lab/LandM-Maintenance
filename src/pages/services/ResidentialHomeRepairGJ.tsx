...
export default function ResidentialHomeRepairGJ() {
  return (
    <ServicePageLayout
      ...
      metaDescription="Find available independent residential home repair providers in Grand Junction, CO. Connect with local service professionals for all types of home repairs. Call (970) 549-6785."
