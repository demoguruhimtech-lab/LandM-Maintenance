...
export default function DrainRepairGJ() {
  return (
    <ServicePageLayout
      ...
      metaDescription="Find available residential drain repair and cleaning providers in Grand Junction, CO. Clogged, slow, or backed-up drains cleared fast. Call (970) 549-6785."
      ...
      faqs={[
        ...
        { q: 'How can I find a drain cleaning provider in Grand Junction?', a: 'Call (970) 549-6785 to connect with available independent local drain repair providers in Grand Junction. Our free service makes it quick and easy to find help.' },
