...
export default function HvacRepairGJ() {
  return (
    <ServicePageLayout
      ...
      metaDescription="Find residential HVAC repair providers in Grand Junction, CO. Heating and cooling system repair and maintenance for your home. Free connection. Call (970) 549-6785."
      ...
      faqs={[
        { q: 'Why is my air conditioner not cooling my Grand Junction home?', a: 'Common causes include a clogged filter, low refrigerant, a dirty evaporator coil, or a malfunctioning compressor. In Grand Junction\'s intense summer heat, AC issues need prompt attention. Call (970) 549-6785 to connect with a local provider.' },
