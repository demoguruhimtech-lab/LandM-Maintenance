...
export default function FaucetRepairGJ() {
  return (
    <ServicePageLayout
      ...
      metaDescription="Connect with residential faucet repair providers in Grand Junction, CO. Dripping faucets, fixture replacements, and more. Free connection service. Call (970) 549-6785."
      ...
      faqs={[
        ...
        { q: 'Can I get my outdoor spigot repaired in Grand Junction before winter?', a: 'Yes. Outdoor hose bibs and frost-free spigots should be inspected and repaired before cold weather arrives in Grand Junction. Call (970) 549-6785 to connect with local providers who can address outdoor water fixtures.' },
