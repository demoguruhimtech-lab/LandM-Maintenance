...
export default function LightingRepairGJ() {
  return (
    <ServicePageLayout
      ...
      metaDescription="Find residential lighting repair and installation providers in Grand Junction, CO. Interior and exterior light fixtures, ceiling fans, and more. Call (970) 549-6785."
      ...
      faqs={[
        ...
        { q: 'How do I connect with a lighting repair provider in Grand Junction?', a: 'Simply call (970) 549-6785 to connect with available independent lighting repair providers in Grand Junction through our free homeowner connection service.' },
      ]}
