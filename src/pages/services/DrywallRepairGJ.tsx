...
export default function DrywallRepairGJ() {
  return (
    <ServicePageLayout
      ...
      metaDescription="Find residential drywall repair providers in Grand Junction, CO. Holes, cracks, water damage, and texture matching for your home. Call (970) 549-6785 to connect."
      ...
      faqs={[
        ...
        { q: 'How do I connect with a drywall repair provider in Grand Junction?', a: 'Call (970) 549-6785 to connect with available independent residential drywall repair providers in Grand Junction through our free connection service.' },
